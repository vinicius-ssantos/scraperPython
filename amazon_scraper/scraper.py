...
class AmazonScraperService:
    ...
    async def scrape(self, query: str) -> list[Product]:
        ...
        # Salvando página HTML e screenshot
        await PageSaver.save_html(page, query)
        await PageSaver.save_screenshot(page, query)
        ...
        for element in product_elements:
            try:
                ...
                if product.title:  # Apenas adiciona produtos válidos
        ...
        if products:
            ...
            output_file = f"output/products/products_{query}_{timestamp}.json"
...
# E o novo scraper.py ficaria EXTREMAMENTE enxuto, apenas orquestrando dependências.
